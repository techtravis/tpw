...
namespace TravisPWalker.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {            
            ...
            // lets extend, no cute notes.  you should realize what these are
            [Required]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _userStore.SetUserNameAsync((SecureUser)user, Input.Email, CancellationToken.None);
                await _emailStore.SetEmailAsync(user, Input.Email, CancellationToken.None);
                var result = await _userManager.CreateAsync((SecureUser)user, Input.Password);
        ...
        private SecureUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(SecureUser)}'. " +
                    $"Ensure that '{nameof(SecureUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
