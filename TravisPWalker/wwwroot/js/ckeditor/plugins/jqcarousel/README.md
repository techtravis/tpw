...
The code also assumes the text area for your editor has an ID of e1
If this is not the case you will need to find all references to e1 in the jscarousel folder and subfolders
CKEDITOR.instances.e1
